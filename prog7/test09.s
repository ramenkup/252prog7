# Formulas with unbalanced parentheses.  Recursion is needed to
# process these.  The unbalance will be detected at level 1.
...
# The original formula: "(a+(x) * (6 + 14) - q7)"
mainFormula1:  .asciiz  "(a+(x  * (6 + 14) - q7)"
