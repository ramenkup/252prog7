# The printFormula function puts various values in $t registers.
# Tests if parens is dependent on the $t registers having the
# same values upon return (parens should not count on this behavior).
