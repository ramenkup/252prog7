# Tests various unbalanced cases where the deeper levels of
# recursion detect the unbalance.
...
# The original formula: "((((17 * (3 + a - b) / 7))+(6-abc)))"
mainFormula1:  .asciiz  "((((17 * (3 + a - b) / 7))+(6-abc)) "
mainFormula2:  .asciiz  "((((17 * (3 + a - b) / 7))+(6-abc)  "
mainFormula3:  .asciiz  "((((17 * (3 + a - b) / 7))+(6-abc  )"
